    ...
    <div style="height:100vh; width:100vw; display:flex">
        ...
        <div style="height:100%; width:80%">
            ...
            <div class="profile-container">
                <form action="/user/{{ $user->id }}", method="post" style="width:70%">
                {{ csrf_field() }}
                        ...
                        <div class="profile_info_input">
                            <div class="col-auto">
                                <div class="input-group mb-2">
                                    ...
                                    @endif
                                    @if(Auth::check() && !Auth::user()->is_authority)
                                        <div style="border:1px solid #d4fada" class="form-control">{{ $user->email }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile_info_input" style="display:flex">
                            <div class="col-auto" style="width:48%">
                                <div class="input-group mb-2">
                                    ...
                                    @endif
                                    @if(Auth::check() && !Auth::user()->is_authority)
                                        <div style="border:1px solid #d4fada" class="form-control">{{ $user->first_name }}</div>
                                    @endif
                                </div>
                            </div>
                            <div class="col-auto" style="width:48%; margin-left:4%">
                                <div class="input-group mb-2">
                                    ...
                                    @endif
                                    @if(Auth::check() && !Auth::user()->is_authority)
                                    <div style="border:1px solid #d4fada" class="form-control">{{ $user->last_name }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile_info_input">
                            <div class="col-auto">
                                <div class="input-group mb-2">
                                    ...
                                    @endif
                                    @if(Auth::check() && !Auth::user()->is_authority)
                                        <div name="phone" style="border:1px solid #d4fada" class="form-control">{{ $user->phone }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
